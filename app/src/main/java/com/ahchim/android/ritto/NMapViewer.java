...
public class NMapViewer extends NMapActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.activity_nmap_viewer);
        ...
        public NMapCalloutOverlay onCreateCalloutOverlay(NMapOverlay itemOverlay, NMapOverlayItem overlayItem,
            ...
            if (overlayItem instanceof NMapPOIitem) {
                ...
                if (poiItem.showRightButton()) {
                    return new NMapCalloutCustomOverlay(itemOverlay, overlayItem, itemBounds,
        ...
        public View onCreateCalloutOverlayView(NMapOverlay itemOverlay, NMapOverlayItem overlayItem, Rect itemBounds) {
            ...
            if (overlayItem != null) {
                ...
                if (title != null && title.length() > 5) {
                    return new NMapCalloutOverlayView(NMapViewer.this, itemOverlay, overlayItem, itemBounds) {
                    };
                }
            }
